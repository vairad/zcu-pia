...
CREATE DATABASE IF NOT EXISTS `revoloot`;
...
CREATE TABLE `revoloot`.`accounts` (
...
INSERT INTO `revoloot`.`accounts` (`id`, `bankCode`, `number`, `prepend`, `amount`, `blocked`, `currency`, `trueAmount`, `customer_id`, `product_id`) VALUES
...
INSERT INTO `revoloot`.`bankers` (`city`, `houseNo`, `postalCode`, `state`, `street`, `email`, `photo`, `secret`, `user`) VALUES
...
CREATE TABLE `revoloot`.`customers` (
...
INSERT INTO `revoloot`.`customers` (`birthDate`, `cardID`, `city`, `houseNo`, `postalCode`, `state`, `street`, `email`, `phone`, `personID`, `id`) VALUES
...
CREATE TABLE `revoloot`.`exchanges` (
  `id` bigint(20) NOT NULL,
...
INSERT INTO `revoloot`.`exchanges` (`id`, `fromCur`, `rate`, `toCur`, `validFrom`) VALUES
...
CREATE TABLE `revoloot`.`hibernate_sequence` (
...
INSERT INTO `revoloot`.`hibernate_sequence` (`next_val`) VALUES
(4),
(4),
(4);
...
CREATE TABLE `revoloot`.`hibernate_sequences` (
...
INSERT INTO `revoloot`.`hibernate_sequences` (`sequence_name`, `next_val`) VALUES
('default', 3);
...
INSERT INTO `revoloot`.`moves` (`id`, `amount`, `bankNote`, `constantSymbol`, `currency`, `bankCode`, `number`, `prepend`, `income`, `message`, `note`, `processed`, `specificSymbol`, `submissionDate`, `transferDate`, `variableSymbol`, `owner_id`) VALUES
...
CREATE TABLE `revoloot`.`products` (
  `id` bigint(20) NOT NULL,
...
INSERT INTO `revoloot`.`products` (`id`, `available`, `marketing`, `name`, `shortText`, `terms`) VALUES
...
CREATE TABLE `revoloot`.`templates` (
  `id` bigint(20) NOT NULL,
  `amount` double DEFAULT NULL,
  `constantSymbol` int(11) DEFAULT NULL,
  `currency` varchar(255) COLLATE utf8_czech_ci DEFAULT NULL,
...
INSERT INTO `revoloot`.`templates` (`id`, `amount`, `constantSymbol`, `currency`, `bankCode`, `number`, `prepend`, `message`, `name`, `note`, `specificSymbol`, `variableSymbol`, `owner_id`, `source_id`) VALUES
...
INSERT INTO `revoloot`.`users` (`id`, `created`, `gender`, `login`, `name`, `password`, `surname`) VALUES
...
--
ALTER TABLE `revoloot`.`customers`
  ADD PRIMARY KEY (`id`);

--
-- Klíče pro tabulku `exchanges`
--
ALTER TABLE `revoloot`.`exchanges`
  ADD PRIMARY KEY (`id`);

--
-- Klíče pro tabulku `hibernate_sequences`
--
ALTER TABLE `revoloot`.`hibernate_sequences`
  ADD PRIMARY KEY (`sequence_name`);

--
-- Klíče pro tabulku `moves`
--
ALTER TABLE `revoloot`.`moves`
  ADD PRIMARY KEY (`id`),
...
--
ALTER TABLE `revoloot`.`products`
  ADD PRIMARY KEY (`id`);

--
-- Klíče pro tabulku `templates`
--
ALTER TABLE `revoloot`.`templates`
  ADD PRIMARY KEY (`id`),
