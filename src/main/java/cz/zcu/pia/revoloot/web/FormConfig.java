...
public class FormConfig {
    ...
    public static final String ACTION_CUSTOMER_UPDATE = ServletNaming.CUSTOMER_UPDATE;
    public static final String ACTION_ADMIN_CUSTOMER = ServletNaming.ADMIN_CUSTOMER;
